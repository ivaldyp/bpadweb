...
<div id="ads" class="bottom pull-right">
	<a href="">
		<img src="{{ ('/mockup-v1/public/img/photo/lelang-bpad.jpeg') }}">
	...
	<div class="col-md-12">
		<!-- <div class="section-title text-center"> -->
			...
			<!-- <div style="text-align: center;">
				<img height="200" src="{{ ('/mockup-v1/public/img/photo/bpad-logo-04b.png') }}">
			</div> -->
...
<div id="testimonial" class="section" style="height: 780px;">
	<!-- background section -->
	<div class="section-bg" style="background-image: url('{{ ('/mockup-v1/public/img/photo/background-00b.jpg')}}');">
	</div>
	<!-- /background section -->
						...
						<div class="article-img">
							<a href="JavaScript:void(0);">
								<span class="text-test" style="">
							        <img style="width: 50px" src="{{ ('/mockup-v1/public/img/photo/bpad-logo-00.png') }}">
							        <hr>
...
<div id="home-owl" class="owl-carousel owl-theme">
	...
	<div class="home-item"  style="overflow: hidden; height: 500px">
		<!-- section background -->
		<div class="section-bg" style="background-image: url('{{ ('/mockup-v1/public/img/slides/bg-2-2.jpg') }}'); background-size: contain; background-repeat: no-repeat;"></div>
		<!-- /section background -->
	</div>
	<!-- /home item -->
	<!-- home item -->
	<div class="home-item"  style="overflow: hidden; height: 500px">
		<!-- section background -->
		<div class="section-bg" style="background-image: url('{{ ('/mockup-v1/public/img/slides/bg-3-2.jpg') }}'); background-size: contain; background-repeat: no-repeat;"></div>
		<!-- /section background -->
	</div>
	<!-- /home item -->	
</div>
